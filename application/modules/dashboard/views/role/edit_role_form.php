            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                         ...
                         <?php $roleStatus = isset($role['0']->status) ? (int) $role['0']->status : 1; ?>
                          <div class="form-group row align-items-center">
                                <label for="type" class="col-sm-2 col-form-label"><?php echo display('role_name') ?> <i class="text-danger">*</i></label>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control" id="status" name="status" tabindex="3" required>
                                        ...
                                        <option value="1" <?php echo ($roleStatus === 1) ? 'selected' : ''; ?>>Active</option>
                                        <option value="0" <?php echo ($roleStatus === 0) ? 'selected' : ''; ?>>Inactive</option>
                                    </select>
                                </div>
                            </div>
