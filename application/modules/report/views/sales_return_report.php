    ...
    <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body" style="margin-left: 120px;">
                ...
                <button type="button" id="btn-filter" class="btn btn-success" onclick="onSalesReturnFilterButtonClick()">
                    Generate Report
                </button>
            </div>
        </div>
...
<script>
    ...
    function onSalesReturnFilterButtonClick() {
        type = type2;
    ...
    function generateReport() {
        $.ajax({
            type: "post",
            url: $('#baseUrl2').val() + 'report/report/sales_return_reportinvoicewise',
            data: {
            ...
            success: function(data1) {
                ...
                if (datas && datas.error) {
                    ...
                    window.open('generate_salesreturnreportinvoice', '_blank');
                } else {
