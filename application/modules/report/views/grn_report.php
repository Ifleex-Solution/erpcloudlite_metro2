			...
			<div class="panel-body" style="margin-left: 120px;">
				...
				<div class="form-group">
					...
					<div class="input-group mr-4" style="width: 250px;">
						<select class="form-control" id="store" name="store" style="width: 250px;" tabindex="1"></select>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="input-group mr-4" style="width: 250px;">
						<select class="form-control" id="supplier_id" name="supplier_id" style="width: 250px;" tabindex="3">
				...
				<button type="button" id="btn-filter" class="btn btn-success" onclick="onGrnFilterButtonClick()">
					Generate Report
				</button>
			</div>
		</div>
...
<script>
	...
	function onGrnFilterButtonClick() {
	...
	function generateReport() {
		$.ajax({
			type: "post",
			url: $('#baseUrl2').val() + 'report/report/grn_reportinvoicewise',
			data: {
			...
			success: function(data1) {
				...
				if (datas && datas.length > 0) {
					window.open('generate_grnreportinvoice', '_blank');
				} else {
