...
<script>
	...
	function onPurchaseReturnFilterButtonClick() {
	...
	function generateReport() {
		$.ajax({
			type: "post",
			url: $('#baseUrl2').val() + 'report/report/purchase_return_reportinvoicewise',
			data: {
			...
			success: function(data1) {
				...
				if (datas.length > 0) {
					window.open('generate_purchasereturnreportinvoice', '_blank');
				} else {
