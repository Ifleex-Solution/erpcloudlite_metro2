                ...
                <div class="form-group row">
                   <label for="ac" class="col-sm-2 col-form-label"><?php echo display('credit_account_head')?></label>
                    <div class="col-sm-4">
                      ...
                      <select name="cmbDebit" class="form-control" id="cmbDebit1" tabindex="1">
                                            <option value="">Select an option</option>
                                            <?php foreach ($all_pmethod as $services) { ?>
                                                <option value="<?php echo $services['id']; ?>" <?php echo $reverseid ==$services['id']?'selected' :'';?>>
                        ...
                        <td class="expenseincometd">  
                            <select name="cmbCode[]" id="cmbCode_<?php echo $sl; ?>" required class="form-control" onchange="load_subtypeOpen(this.value,<?php echo $sl; ?>)">
                              ...
                              <?php foreach ($acc as $services) { ?>
                                                <option value="<?php echo $services['HeadCode']; ?>" <?php echo $voucher->COAID ==  $services['HeadCode']?'selected' :'';?> >
