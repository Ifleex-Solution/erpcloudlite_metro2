                ...
                <div class="panel-body print-font-size">
                    <div class="row">
                        ...
                        <div class="col-xs-4 text-left">
                            <h2 class="m-t-0">Contra Voucher</h2>
                            <div>
                    ...
                    <table class="invoice-details" width="100%">
                        <tr>
                            ...
                            <th style="border-bottom: 2px solid; border-top: 2px solid; padding: 5px; font-size: 14px;">Transferred From</th>
                            <th style="border-bottom: 2px solid; border-top: 2px solid; padding: 5px; font-size: 14px;">Transferred To</th>
                        ...
                        <tr>
                            ...
                            <td style="padding: 5px; font-size: 14px;"><?php echo $from_name; ?></td>
