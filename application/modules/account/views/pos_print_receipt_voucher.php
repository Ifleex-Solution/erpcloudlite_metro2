                ...
                <div class="panel-body print-font-size">
                    <div class="row">
                        ...
                        <div class="col-xs-4 text-left">
                            <h2 class="m-t-0">Receipt Voucher</h2>
                            <div>
                            ...
                            <div>
                                <abbr class="font-bold">Receipt: </abbr><?php echo $from_name; ?>
                            </div>
                            <?php if (!empty($remark)): ?>
                            <div>
                    ...
                    <table class="invoice-details" width="100%">
                        <tr>
                            ...
                            <th style="border-bottom: 2px solid; border-top: 2px solid; padding: 5px; font-size: 14px;">Payment Method</th>
