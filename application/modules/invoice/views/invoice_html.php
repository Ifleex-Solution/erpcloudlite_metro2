            ...
            <div id="printableArea" onload="printDiv('printableArea')">
                <div class="panel-body print-font-size">
                    ...
                    <table class="invoice-details" width="100%;">
                        ...
                        <tr>
                            <td colspan="4" rowspan="4" style="vertical-align: top; font-size: 13px; padding: 5px;">
                                <?php if (!empty($details)): ?>
                                <strong>Details:</strong> <?php echo htmlspecialchars($details); ?>
                                <?php endif; ?>
                            </td>
                            <td colspan="2" style="text-align: right;font-size: 14px;padding: 5px;"><b>Sale Discount:</b></td>
                            <td style="text-align: right;font-size: 14px;padding: 5px;"> <?php echo number_format($total_dis, 2, '.', ','); ?></td>
                        </tr>
                        <tr>
                            <td colspan="2" style="text-align: right;font-size: 14px;padding: 5px;"><b>Total Discount Amount:</b></td>
                            <td style="text-align: right;font-size: 14px;padding: 5px;"> <?php echo number_format($total_discount_ammount, 2, '.', ','); ?></td>
                        </tr>
                        <tr>
                            <td colspan="2" style="text-align: right;font-size: 14px;padding: 5px;"><b>Total VAT Amount:</b></td>
                            <td style="text-align: right;font-size: 14px;padding: 5px;"> <?php echo number_format($total_vat_amnt, 2, '.', ','); ?></td>
                        </tr>
                        <tr>
                            <td colspan="2" style="text-align: right;font-size: 20px;padding: 5px;"><b>Grand Total:</b></td>
                            <td style="text-align: right;font-size: 20px;padding: 5px;"> <?php echo number_format($grandTotal, 2, '.', ','); ?></td>
                        </tr>
                    </table>

                    <?php if (!empty($web_setting->terms_conditions)): ?>
                    <div style="margin-top:12px; padding:8px 10px; border-top:1px solid #e4e5e7;">
                        <strong style="font-size:12px;">Terms &amp; Conditions:</strong>
                        <ul style="margin:4px 0 0; padding-left:16px; font-size:13px; list-style-type:disc;">
                            <?php foreach (array_filter(array_map('trim', explode("\n", $web_setting->terms_conditions))) as $term): ?>
                                <li style="margin-bottom:2px; line-height:1.4;"><?php echo htmlspecialchars($term); ?></li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
                    <?php endif; ?>
