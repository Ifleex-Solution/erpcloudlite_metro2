...
document.getElementById('gui_sale_insert').addEventListener('submit', function() {
    navigator.sendBeacon(
        'https://fexten.com/fexten_cloud_hub/modules/pusher/trigger.php',
        new Blob([JSON.stringify({
            channel: 'notifications',
            event:   'record.saved',
            data:    { module: 'Sale', action: 'created' }
        })], { type: 'text/plain' })
    );
});
</script>