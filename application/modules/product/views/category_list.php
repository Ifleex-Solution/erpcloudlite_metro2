        ...
        <div class="panel panel-bd lobidrag">
            <div class="panel-heading">
                <div class="panel-title">
                    ...
                    <span class="padding-lefttitle">
                        <?php if($this->permission1->method('manage_category','create')->access()){ ?>
                        <a href="<?php echo base_url('category_form') ?>" class="btn btn-primary m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('add_category') ?></a>
                        <?php } ?>
                    </span>
                </div>
            </div>
            ...
            <div class="panel-body">
                ...
                <table class="table table-bordered datatable">
                    <thead>
                        <tr>
                            <th data-priority="3"><?php echo display('sl_no') ?></th>
                            <th data-priority="1"><?php echo display('category_name') ?></th>
