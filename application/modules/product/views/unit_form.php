     ...
     <div class="col-sm-12">
         <div class="panel panel-bd lobidrag">
             ...
             <div class="panel-body">
                 <?php echo form_open('unit_form/'.$unit->unit_id, 'class="" id="unit_form" onsubmit="return validateForm(event)"')?>

                 <input type="hidden" name="unit_id" id="unit_id" value="<?php echo $unit->unit_id?>">

                 <div class="form-group row">
                     <label for="unit_name" class="col-xs-12 col-sm-2 text-right col-form-label"><?php echo display('unit_name')?> <i class="text-danger"> * </i>:</label>
                 ...
                 <div class="form-group row">
                     <label for="unit_display_name" class="col-xs-12 col-sm-2 text-right col-form-label">Print Name:</label>
                     <div class="col-xs-12 col-sm-4">
...
<?php echo "<script>var unitId=" . json_encode(!empty($unit->unit_id) ? (int)$unit->unit_id : 0) . ";</script>"; ?>
<script>
...
function validateForm(event) {
    ...
    var unitDisplayName  = $('#unit_display_name').val().trim();
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo base_url("product/product/api_save_unit"); ?>',
        data: {
