                ...
                <div class="panel-body print-font-size">
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            ...
                            <br>
                            <span class="label label-success-outline m-r-15 p-10">Return From</span>
                        ...
                        <div class="col-xs-4">
                            ...
                            if ($web_setting->is_qr == 1) { ?>
                                <div class="print-qr">
                                    <?php $text = base64_encode('Return No: ' . $invoiceno . ' Supplier: ' . $supplier_name); ?>
                        ...
                        <div class="col-xs-4 text-left">
                            ...
                            <?php if (!empty($purchase_chalan_no)): ?>
                            <div>
                                <abbr class="font-bold">Purchase No: </abbr><?php echo $purchase_chalan_no; ?>
                            </div>
                            <?php endif; ?>
                            <div class="m-b-15">
                            ...
                            <span class="label label-success-outline m-r-15">Return To</span>
